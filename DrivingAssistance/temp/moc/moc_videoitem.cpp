...
QT_MOC_LITERAL(1, 10, 11), // "SendVideoId"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 2), // "id"
QT_MOC_LITERAL(4, 26, 18) // "on_PlayBtn_clicked"

    },
    "VideoItem\0SendVideoId\0\0id\0on_PlayBtn_clicked"
};
...
void VideoItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VideoItem::SendVideoId)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void VideoItem::SendVideoId(int _t1)
{
